...
<body>
   ...
   <input type="button" value="add" id="btn-add" onclick="addalimento();">
   </div> 
   <div id="tabela">
   ...
   <div>
   	<form method="POST" action="">
        ...
        <input type="hidden" name="total_calorias" value="" id="total_calorias" />
        ...
        <input type="hidden" name="id_alimento" value="" id="id_alimento" />
        
        <label class="hidden" for="favoritos">Favoritos:</label>
        <input type="hidden" name="favoritos" value="f" id="favoritos" />
        ...
        <input type="submit" name="acao" id="acaos" value="SALVAR"/> 
			...
			<ul id="nova_tabela" class="resultado"> 
     		</ul>
   </div> 
   ...
   <div class="addalimento tb" id="tb2" >
        <div id="janela_add" class="box_input">
            ...
            <input type="text" placeholder="Porção">           
            <input type="text" placeholder="Categoria"/>
            <input type="number" placeholder="Quantidade de Calorias"/>
            <input type="button" value="Cadastrar" id="btn-salvar"/>
        </div>
    </div>
